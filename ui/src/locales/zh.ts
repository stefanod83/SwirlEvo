export default {
    ...
    "stack_addon_traefik": {
        ...
        "port": "端口",
        "certresolver": "证书解析器",
        "extras_title": "高级标签（passthrough）",
        "extras_subtitle": "向导无法原生建模的 traefik.* 标签 — 额外路由、tls.options、带 provider 限定（@file）的中间件、插件。保存时原样写回。",
    ...
    "host_addon_traefik": {
        ...
        "detected": "运行时容器",
        "ref_stack": "引用栈",
        "ref_stack_placeholder": "可选 — 在该主机上运行 Traefik 的托管栈",
